...
Are you looking for a quasar component to working with money format? Maybe it can help you.
...
```js
import Vue from "vue";
import VuetifyMask from "quasar-money";
Vue.use(VuetifyMask);
